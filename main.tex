...
Analizar la relación que existe entre los accidentes automovilísticos en la zona metropolitana de Guadalajara, sus causas y efectos. También las posibilidades que existen de prevención mediante políticas públicas que impacten de manera positiva y beneficien a la sociedad. Asimismo, se propone la evaluación de datos verídicos que nos permitan detectar fenómenos sociales y a su vez, poder plantear una solución que sea benefactora para los locatarios de la comunidad, además de poder cumplir el objetivo de salvar vidas y poder contribuir al problema de tráfico vial.
